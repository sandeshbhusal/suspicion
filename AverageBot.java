...
public class AverageBot extends Bot {
    ...
    private float getGain(GameState gameState, String guest, String player, String board) {
        ...
        float gain = Math.max((totalGuessLength + trueFrac)/playerCount, (totalGuessLength + falseFrac)/playerCount);
    ...
    public AverageBot(String playerName, String guestName, int numStartingGems, String gemLocations, String[] playerNames, String[] guestNames) {
