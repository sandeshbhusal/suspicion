...
public class SandBotGini extends Bot
{
    Random r = new Random();
    ...
    public String pickPlayerToQuestion(String otherGuest) {
        ...
        for (String p: possiblePlayerAnswers.keySet()) {
            ...
            System.out.println("@SandBot: Gini for " + p + " is " + Gini); 
            if (Gini > highestGini) {
                highestGini = Gini;
                selectedPlayer = p;
            }
    ...
    public SandBotGini(String playerName, String guestName, int numStartingGems, String gemLocations, String[] playerNames, String[] guestNames)
    {
